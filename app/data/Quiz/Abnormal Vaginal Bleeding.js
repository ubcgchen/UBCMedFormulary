...
export const Abnormal_Vaginal_Bleeding = [
  ...
  },
  {
    ...
    correct: "Alters prostaglandins (PG) balance to favor PGF2α resulting in v/c and increased PLT aggregation",
  ...
  {
    id: 7,
    prompt: "Which of the following patients would oral hormone (estrogen) therapy most likely be indicated in (Assume no CV risk factors or breast Ca hx unless stated)?",
    choices: [
  ...
  {
    id: 8,
    prompt: "A 40 y/o patient with primary ovarian insufficiency presents to her Ob/Gyn. If you want to achieve the same effect with the 4 options, then which of the following correctly outlines the required dose from lowest to highest?",
    choices: [
  ...
  },
  {
    ...
    correct: "Yes, we can try medroxyprogesterone acetate, if there are no signs of invasion on MRI",
