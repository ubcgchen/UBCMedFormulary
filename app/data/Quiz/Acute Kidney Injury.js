...
export const acuteKidneyInjury = [
  ...
  },
  {
    ...
    choices: ["Apixaban", "Clopidogrel", "Ramipril", "Rosuvastatin", "B and C"],
    correct: "Ramipril",
  ...
  },
  {
    ...
    choices: ["Aspirin", "Calcium gluconate", "Canagliflozin", "Furosemide"],
    correct: "Furosemide",
    tags: ["PK", "medium", "Endocrinology"],
    explain:
      "This question requires recognizing the treatment of a volume overloaded patient with an AKI. In this vignette, we are presented with a volume overloaded patient given the JVP, S3 heart sounds, probably pulmonary and peripheral edema. In fact, he probably has heart failure leading to compromised renal perfusion (probably cardiorenal syndrome), which could be the cause of his AKI. In this case we would go with (D), a loop diuretic, because it is the most efficacious diuretic we have to get rid of the excessive fluid and hopefully help with his heart function if we decrease the patient’s preload. (A) is something we would avoid in this case. (B) is a membrane stabilizer during hyperkalemia, but does not address the patient's main issue. In addition, calcium gluconate is typically not added until hyperkalemia-associated ECG findings are observed (typically not until >6 mM). (C) is a SGLT2i and would probably have little effect in this case.",
  },
  {
    id: 5,
    prompt:
  ...
  },
  {
    ...
    explain:
      "This question requires knowing the medications that could cause hyperkalemia. In this case (C) is the only medication here that shouldn’t cause hyperkalemia, in fact it should cause hypokalemia given it is a thiazide diuretic acting in the distal tubules (results in renin and aldosterone release, which causes K+ loss). (A) digoxin inhibits Na+/K+ ATPase pumps, leading to decreased K+ delivery into principal cells for excretion. (B) heparin can inhibit production of aldosterone (a cause of Type 4 renal tubular acidosis), thus decreased K+ loss. (C) Ramipril is an ACEi, leading to decreased RAAS, resulting in less aldosterone. (E) is a potassium sparing diuretic by inhibiting the mineralocorticoid receptor, thus blocking aldosterone effects.",
  },
  {
    id: 11,
    prompt:
