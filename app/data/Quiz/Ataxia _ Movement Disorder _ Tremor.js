...
export const ataxia_movementDisorder_tremor = [
  {
    ...
    explain: "This question requires recognizing essential tremor and the treatment for it. In this vignette, we are presented with a patient with a postural and action tremor of her hands that is symmetrical, constant (no intention tremor), fairly high frequency, and not on medications or thyroid issues. The top DDx would be ET in this case, which is treated with a nonselective β blocker (E). The β2 receptor is thought to be implicated in tremor, whether it is through decreased blood flow to skeletal muscle or spindle sensor, is not known. Hence, β1 selective blockers (D) are not useful. We don’t suspect physiological tremor as much given the history, hence (D) is incorrect. (A) is mostly used for levodopa induced dyskinesias in PD patients. (B) a BDZ, and (C) a gabapentinoid are both 2nd line choices."
  },
  {
    id: 2,
    prompt:
  ...
  {
    id: 8,
    prompt: "A 68 y/o patient with Parkinson’s disease presents to his neurologist after noticing that his levo-dopa only works for 3 hours before he has dystonias and freezing of gait occurring. Which of the following is NOT a valid intervention for this patient?",
    choices: [
      "Add entacapone",
      "Add rasagiline",
      "Add pramipexole",
  ...
  },
  {
    id: 16,
    prompt:
      "A 34 y/o patient in the psychiatry ward starts presenting with restlessness, agitation, and fixed stare. He eventually progresses to twisting of his head and neck to one side at an angle (torticollis) and stridor, spasms of his mastication muscles, and eventually neck and trunk hyperextension. The healthcare team is able to secure his airway. Going over the chart it is noted that his medications were switched 2 days ago from haloperidol PO to haloperidol IV. Treatment of this presentation is done with?",
    choices: [
      "5-HT antagonist",
      "D2 antagonist",
      "H1 antagonist",
    ...
    correct:
      "C or D",
    tags: ["PD", "MoA", "medium", "Endocrinology", "Nephrology"],
    explain: "This question requires recognizing an acute dystonia reaction (ADR) and how to manage one. In this vignette we are presented with a patient with ADR given the prodrome of restlessness and agitation, which progresses into dystonia. We are also given a history where he had a recent increase in neuroleptic dosage, or in this case a change in administration from PO to IV. The treatment after managing the ABCs is to give him an antihistamine or an anticholinergic, therefore the correct answer is (E). The medications we use are diphenhydramine (IV/IM; 1st gen H1 antagonist), benztropine (IV/IM; M1 + H1 antagonist), or benzodiazepines such as clonazepam which is a GABA potentiator."
  },
  {
    id: 17,
    prompt:
    ...
    correct:
      "Serotonin Syndrome",
    tags: ["PD", "MoA", "medium", "Endocrinology", "Nephrology"],
    explain: "This question requires recognizing serotonin syndrome. In this vignette we are presented with a patient that is on a SSRI and a positive tox screen for MDMA, a 5-HT releasing agent. That should clue us into the fact that he has increased serotonin in his body. There are lots of overlap in the presentations such as dysautonomia, hyperthermia, and altered mental status. However, we can distinguish NMS from serotonin syndrome if we recall that NMS classically has bradykinesia and extrapyramidal “lead pipe” rigidity, while in serotonin syndrome it is hyperkinesia and clonus. We also can have pyramidal signs in 5-HT syndrome (positive Babinski). Therefore, (E) is the correct answer. (C) is NMS, but in a specifically related to anesthesia in the OR due to succinylcholine or halogenated inhaled anesthetics in predisposed individuals. (B) is something we could see with increased 5-HT, MAO inhibitors, and tyramine exposure (wine, cheese). (A) see other questions with ADR."
  },
  {
    id: 18,
    prompt:
      "A 35 y/o female presents to the clinic with a three-month history of neck pain and abnormal head position. She reports involuntary muscle contractions that pull her head to the left, causing discomfort and difficulty with daily activities. On examination, the patient's neck muscles are tight and tender, and her head is tilted to the left with her chin pointing towards her right shoulder. The neurologic exam is otherwise unremarkable. Which of the following is the MOST appropriate treatment option for this patient's condition?",
    choices: [
      "Trihexyphenidyl",
      "Benztropine",
      "Botox injection",
    ...
    correct:
      "Botox injection",
    tags: ["PD", "MoA", "medium", "Endocrinology", "Nephrology"],
    explain: "This question requires understanding the management of cervical dystonia. In this vignette we are presented with a patient with neck pain and abnormal head position that is caused by involuntary muscle contractions. The physical examination reveals that the patient's head is tilted to the left with her chin pointing towards her right shoulder. This presentation is suggestive of cervical dystonia, a type of focal dystonia that affects the muscles of the neck. The most appropriate treatment for this condition is (C) Botox injection. Botox is a neurotoxin that cleaves SNARE proteins on membranes in the axon terminal to prevent vesicle fusion and subsequent release of acetylcholine, thus leading to muscle paralysis. Remember ACh is released at NMJs where it activates nicotinic ACh receptors to cause skeletal muscle contraction. Therefore, when botox is injected to specific muscles in the neck it will temporarily paralyze them and reduce the involuntary muscle contractions. Trihexyphenidyl (A) and benztropine (B) are anticholinergic medications that's used in tardive dystonia, acute dystonic reaction, and potentially in cervical dystonia, but are not first line like Botox. Botox can be delivered specifically to the affected muscles. Dantrolene (D) is a muscle relaxant that is sometimes used in neuroleptic malignant syndrome. It acts by blocking the ryanodine receptors, thereby reducing Ca release from the sarcoplasmic reticulum. Diazepam (E) is a benzodiazepine that is used to treat anxiety, muscle spasms, and seizures, but it is not a first-line treatment for cervical dystonia."
  },
];
