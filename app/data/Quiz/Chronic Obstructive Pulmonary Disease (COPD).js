export const data = [
    ...
    {
        "id" : 2,
        "prompt" : "You need to prescribe a long acting bronchodilator to a patient with worsening COPD. After discussing treatment goals and concerns with your patient, you decide to prescribe tiotropium. What is the mechanism of action of tiotropium?",
        "choices": [
        ...
        "correct": "Blocks muscarinic 3 acetylcholine receptors leading to smooth muscle relaxation",
    ...
    },
   {
        ...
        "correct": "Long term LABA usage will desensitize β2 adrenoreceptors, thus requiring a larger SABA dose.",
        "tags":["PD","medium","MoA","Pulmonology"]
    },  
    {
        "id" : 4,
        "prompt" : "A 7 y/o patient is recently diagnosed with asthma and is prescribed a budesonide/formoterol inhaler. However, he mistakens his father’s propranolol (β-blocker) as candy and ingests some. Through which mechanism(s) will the patient’s medication work now?",
        "choices": [
...
{
        "id" : 9,
        "prompt" : "What is the mechanism of action for drugs like montelukast and zafirlukast?",
        "choices": [
        ...
        "correct": "Blocks cysteinyl leukotriene receptors leading to decreased smooth muscle contraction, edema, and inflammation",
        "tags":["PD","easy","MoA","Pulmonology"]
    },
{
        "id" : 10,
        "prompt" : "A 64 y/o COPD patient comes in for a checkup after worsening symptoms and 3 exacerbations in the last year. She undergoes a pulmonary function test (PFT). Her PFT reports a FEV1/FVC = 0.64 and FEV1 = 42% predicted. The respirologist decides to add a medication to help control her COPD and educates her on proper usage of the inhaler such as rinsing her mouth after use. Which of the following side effects of the newly added drug is the respirologist specifically trying to avoid?",
        "choices": [
            "Dry mouth",
            "Fatigue",
            "Oral candidiasis", 
...
{
        "id" : 11,
        "prompt" : "What is the importance of asking the patient to hold their breath following use of a metered-dose inhaler?",
        "choices": [
