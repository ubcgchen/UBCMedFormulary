...
export const Sepsis = [
  ...
  },
  {
    id: 3,
    prompt:
      "Which of the following is NOT effective against MRSA?",
    choices: [
      "Ceftaroline",
  ...
  {
    id: 7,
    prompt: "Which of the following is the LEAST likely resistance mechanism for Gram + and Gram - bacteria against ABXs like gentamicin?",
    choices: [
      "Altered target",
  ...
  },
  {
    ...
    correct: "Concentrated in the urine via glomerular filtration and renal tubular secretion, allowing it to achieve minimum effective concentration in the desired compartment",
  ...
  },
  {
    ...
    correct: "Surgical debridement + switch empiric ABX to IV cefazolin, then PO cephalexin + rifampin",
  ...
  },
  {
    id: 22,
    prompt:
      "Which of the following is FALSE regarding fluoroquinolones?",
    choices: [
  ...
  },
  {
    ...
    correct: "Amphotericin B → binds to ergosterol in the cell membrane, leading to pore formation, which causes ion leakage and thus cell death",
    tags: ["PD", "medium", "side effects", "Endocrinology"],
  ...
  },
  {
    ...
    tags: ["PD", "medium", "side effects", "Endocrinology"],
    explain: "This question requires understanding what MIC is. The correct answer is (B). This can be thought of as the potency of the ABX. The lower the MIC, the less ABX is needed to inhibit bacteria growth."
  },
  {
    id: 26,
    prompt:
