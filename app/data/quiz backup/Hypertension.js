...
{
        "id" : 6,
        "prompt" : "Which of the following is a legitimate difference between ramipril and valsartan?",
        "choices": [
            "Ramipril has a vasodilatory effect due to decreased bradykinin breakdown",
            "Ramipril is a renin inhibitor, while valsartan is an angiotensin receptor 1 blocker",
            "Ramipril is an ACE inhibitor, while valsartan is an angiotensin receptor 2 blocker", 
            "Valsartan is contraindicated in asthma, while ramipril is contraindicated in renal artery stenosis",
            "Valsartan has a vasodilatory effect due to decreased bradykinin breakdown"],
        "correct": "Ramipril has a vasodilatory effect due to decreased bradykinin breakdown",
        "tags":["PD","easy","MoA","Cardiology"]
    }, 
{
        "id" : 7,
        "prompt" : "A 50 y/o patient with type 2 diabetes mellitus and hypertension presents to the nephrology clinic after a recent diagnosis of diabetic nephropathy (progressive damage to the kidneys due to high blood pressure and hyperglycemia). The nephrologist suggests that the patient’s medication should be switched from amlodipine to an ACE inhibitor (ACEi) to help slow down the progression of his kidney disease. Is this an appropriate intervention, why or why not?",
        "choices": [
            ...
            "Yes, ACEi will lead to efferent arteriole vasodilation, which will reduce intraglomerular pressure and hyperfiltration (decrease GFR), thus protecting the glomerulus", 
        ...
        "correct": "Yes, ACEi will lead to efferent arteriole vasodilation, which will reduce intraglomerular pressure and hyperfiltration (decrease GFR), thus protecting the glomerulus",
...
{
        "id" : 9,
        "prompt" : "A 72 y/o patient with hypertension, asthma, and idiopathic bradycardia presents to the clinic to change his HTN medication. He has had trouble tolerating the side effects of ACEi, ARB, diuretics, and both classes of CCB. The only class left are the β-blockers, but your preceptor is apprehensive in prescribing one given his comorbidities. Using your knowledge of pharmacodynamics you would suggest which β-blocker?",
        "choices": [
            "Acebutolol",
            "Atenolol",
            "Carvedilol", 
