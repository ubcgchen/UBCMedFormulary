export const pharmacokinetics = [
    ...
    {
        "id" : 2,
        "prompt" : "A patient with chronic pain that is well managed with a painkiller (Drug X) was prescribed a proton pump inhibitor (PPI) last week. Yesterday, they noticed that the painkiller is as effective as before. Which of the following statements could explain this",
        "choices": [
    ...
    {
        "id" : 3,
        "prompt" : "Drug X and Drug Y are used for the same indication with the same route of administration and have identical properties except that Drug X is more lipid soluble and binds plasma proteins significantly more than Drug Y. Which of the following is a false statement?",
        "choices": [
            "Hypoalbuminemia secondary to hepatic disease will lead to higher amounts of free Drug X in plasma",
            "Concomitant use of drugs that also heavily bind albumin will affect Drug X more than Drug Y",
    ...
    },
  {
        ...
        "correct": "CYP3A4 catalyzes a reaction that exposes a -OH functional group, thus making Drug X more polar",
        "tags":["PK","easy","Foundations"]
    },
{
        "id" : 5,
