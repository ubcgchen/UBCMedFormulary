export const pregnancy = [
    ...
    },
   {
    ...
    {
        "id" : 4,
        "prompt" : "A 32 y/o pregnant patient G3T1P1 presents to the ER with a stiff neck, fever, and headache. She is eventually diagnosed with listeriosis after eating some cheese at a wine and cheese event with her husband. She is started on ampicillin, an antibiotic that is effective against Listeria and largely excreted unchanged renally. What sort of changes to dosing would you expect in a pregnant patient?",
        "choices": [
