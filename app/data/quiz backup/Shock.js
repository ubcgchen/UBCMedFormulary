...
export const Shock = [
  ...
  },
  {
    ...
    choices: ["Diltiazem", "Lidocaine", "Metoprolol", "Sotalol", "B and D"],
    correct: "Sotalol",
    tags: ["PD", "hard", "Endocrinology", "MoA", "side effects"],
    explain:
  ...
  },
  {
    id: 7,
    prompt:
      "A cardiologist hands you an ECG, which shows a wide QRS complex and a prolonged QT interval. He asks you what drug could possibly cause this ECG pattern?",
    choices: [
      "Amiodarone",
      "Diltiazem",
      "Flecainide",
  ...
  },
  {
    id: 8,
    prompt:
      "Which of the following medications would you MOST likely expect to prolong the PR interval?",
    choices: ["Amiodarone", "Lidocaine", "Metoprolol", "Verapamil", "C + D"],
    correct: "C + D",
  ...
  },
  {
    id: 9,
    prompt:
      "Arveen is a 65 y/o patient presenting to the ER in cardiac arrest. ROSC (resume of spontaneous circulation) is achieved. An ECG reading moments before he went into cardiac arrest and shows polymorphic wide QRS ventricular tachycardia that has oscillatory changes in amplitude of the QRS complexes around the isoelectric line (“twists'' around the isoelectric line) that degenerating into VFib. Given this presentation, which of the following medications is the LEAST likely to cause the described ECG pattern?",
    choices: [
      "Amiodarone",
      "Ciprofloxacin",
      "Propafenone",
  ...
  {
    id: 13,
    prompt: "Which of the following is true when treating reentry arrhythmias?",
    choices: [
  ...
  {
    id: 19,
    prompt: "Which of the following is NOT true about the β1 adrenoreceptor?",
    choices: [
  ...
  {
    id: 20,
    prompt: "Which of the following is an effect of the α2 adrenoreceptor?",
    choices: [
