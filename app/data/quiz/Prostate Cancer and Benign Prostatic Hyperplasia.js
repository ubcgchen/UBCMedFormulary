...
export const Prostate_Cancer_and_Benign_Prostatic_Hyperplasia = [
  ...
  {
    id: 7,
    prompt: "Which of the following correctly describes why tamsulosin is preferred over terazosin in treating BPH?",
    choices: [
  ...
  },
  {
    ...
    correct: "No, sildenafil only works if you are sexually aroused, so you shouldn’t achieve an erection when not aroused",
  ...
  },
  {
    ...
    explain: "This question requires understanding the treatment of advanced prostate Ca. In this vignette we are presented with a patient with advanced prostate Ca given his Gleason score and the evidence of bone mets. This makes androgen deprivation therapy an option in his treatment. This is usually done with a GnRH agonist in combination with an androgen receptor blocker for a few wks at the start. Therefore, the correct answer is (C). Goserelin is a GnRH agonist (other ex: leuprolide) and bicalutamide is an androgen receptor (AR) antagonist (other ex: flutamide, nilutamide (-lutamide)). It seems counterintuitive to use a GnRH agonist, as this would cause LH release, which should then cause more T, when we should be decreasing T since that is a driving force behind prostate Ca. However, if we recall from endocrinology, GnRH is released in a pulsatile manner, if we add exogenous GnRH and cause continuous stimulation of GnRH receptors on the ant. pituitary then we actually cause downregulation of the receptors. The end result is decreased LH release in the long run. In the short term, such as initiation of therapy, there will be a T surge from the initial increased LH release, thus we counter this with an AR antagonist like bicalutamide. The side effects of ADT are as you would expect with low T states (low libido, gynecomastia, osteoporosis (OP), etc..), but also metabolic syndromes."
  },
  {
    id: 10,
    prompt:
  ...
  },
  {
    id: 14,
    prompt:
      "You are at an urology clinic and the waiting room is filled with many patients. To streamline the process, your preceptor asks you to review the charts and tell her the patients with contraindications to oxybutynin. From the list you select?",
    choices: [
      "Harry, 57 y/o with postural hypotension",
    ...
    correct: "Niall,  57 y/o with a history of sinus tachycardia with aberrancy (LBBB)",
    tags: ["PD", "medium", "side effects", "Endocrinology"],
